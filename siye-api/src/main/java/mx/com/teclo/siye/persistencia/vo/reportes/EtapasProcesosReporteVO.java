...
public class EtapasProcesosReporteVO implements Serializable {
	...
	List<EtapasEncuestaReporteVO> encuestas;
	...
	public List<EtapasEncuestaReporteVO> getEncuestas() {
		return encuestas;
	}
	public void setEncuestas(List<EtapasEncuestaReporteVO> encuestas) {

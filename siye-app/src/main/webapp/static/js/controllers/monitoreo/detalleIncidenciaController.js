...
angular.module(appTeclo).controller('detalleIncidenciaController', function($scope, $filter,altaIncidenciaService, $timeout, $window, growl, ModalService, showAlert, $location, Lightbox,monIncidenciaService) {

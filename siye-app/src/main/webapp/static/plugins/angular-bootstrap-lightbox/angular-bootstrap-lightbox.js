...
angular.module('bootstrapLightbox').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('lightbox.html',
    ...
    "			<a class=\"btn btn-primary btn-xs btn-default\" ng-click=Lightbox.prevImage()>‹ Anterior</a> " +
//    "			<a ng-href={{Lightbox.imageUrl}} target=_blank class=\"btn btn-xs btn-default\" title=\"Open in new tab\">" +
//    "				Open image in new tab" +
//    "			</a> " +
    "			&nbsp;&nbsp;<a class=\"btn btn-primary btn-xs btn-default\" ng-click=Lightbox.nextImage()>Siguiente ›</a>" +
    "		</div>" +
    "	</div>" +
...
//    "			</video>" +
    ...
    "				<source ng-src='{{Lightbox.imageUrl}}'>" +
    "			</video>"+
...
//    "			</embed-video>" +
    "		</div>" +
    "		<div>" +
    "			<audio  width='80%' controls ng-if='fotografia.tipo == 3'>" +
    "				<source ng-src='{{Lightbox.imageUrl}}'>" +
    "			</audio>" +
    "		</div>" +
    "	</div>" +

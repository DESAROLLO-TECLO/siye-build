...
angular.module('angular-growl').directive('growl', [function () {
    ...
    return {
      restrict: 'A',
      templateUrl: 'views/templatedirectivas/growlNotify.html',
      replace: false,
      scope: {
        reference: '@',
        inline: '=',
...
angular.module('angular-growl').provider('growl', function () {
  ...
  //Se agregó
  this.positionMod = function (positionMod) {
	  _positionMod = positionMod;
	  return this;
  };
  ...
  this.$get = [
    ...
    function ($rootScope, $interpolate, $sce, $filter, $interval, growlMessages) {
      ...
      function sendMessage(text, config, severity) {
        ...
        //Se agregó
//        if(_config.newposition != undefined) {
//        	_position = _config.newposition;
//        }
